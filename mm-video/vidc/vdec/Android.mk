...
libmm-vdec-inc          += hardware/qcom/display-$(TARGET_QCOM_DISPLAY_VARIANT)/libcopybit
libmm-vdec-inc          += frameworks/av/include/media/stagefright
libmm-vdec-inc          += hardware/qcom/display-$(TARGET_QCOM_DISPLAY_VARIANT)/libqservice
libmm-vdec-inc          += frameworks/av/media/libmediaplayerservice
libmm-vdec-inc          += frameworks/native/include/binder
libmm-vdec-inc          += hardware/qcom/display-$(TARGET_QCOM_DISPLAY_VARIANT)/libqdutils
...
mm-vdec-test-inc    := hardware/qcom/media-$(TARGET_QCOM_MEDIA_VARIANT)/mm-core/inc
...
mm-vdec-drv-test-inc    := hardware/qcom/media-$(TARGET_QCOM_MEDIA_VARIANT)/mm-core/inc
